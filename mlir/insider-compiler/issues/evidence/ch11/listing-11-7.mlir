gpu.module @matmul_kernel {
  gpu.func @matmul(%A: memref<128x256xf32>, %B: memref<256x512xf32>, %C: memref<128x512xf32>) kernel {
    ...
    scf.if %in_bounds {
      ...
      %final_sum = scf.for %k = %c0 to %c256 step %c1 iter_args(%sum_iter = %sum_init) -> (f32) {
