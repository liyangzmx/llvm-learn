module {
  func.func @vect() -> vector<4x16xf32> {
    ...
    %0 = builtin.unrealized_conversion_cast %cst_0 : vector<4x16xf32> to !llvm.array<4 x vector<16xf32>>
    ...
    %5 = builtin.unrealized_conversion_cast %4 : !llvm.array<4 x vector<16xf32>> to vector<4x16xf32>
